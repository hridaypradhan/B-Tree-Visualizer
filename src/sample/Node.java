...
public class Node<T extends Comparable<T>> {
    ...
    public T replaceMax() {
        ...
        if (isLeaf()) {
            ...
            if (getRightElement() != null) {
                ...
                // We are lucky, we do not need to re-balance anything
            } else {
                max = getLeftElement();
                setLeftElement(null);
                // At the first stage of the recursive function, re-balancing will occur
            }
        }
    ...
    /**
     * Method for maintaining balance by re-balancing the deepest level of the tree starting from the second deepest
     */
    void reBalance() {
